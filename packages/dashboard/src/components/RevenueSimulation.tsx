      ...
      <CardContent className="space-y-5">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="text-right">
            <p className="text-xs text-muted-foreground mb-0.5">{t("simulation.subscriptionPrice")}</p>
            ...
            return (
              ...
              >
                ...
                <p className="text-xs text-muted-foreground">
                  {t("simulation.conversionRate")} {(s.conversionRate * 100).toFixed(1)}% · {s.subscribers}{t("simulation.subscribers")}
                </p>
